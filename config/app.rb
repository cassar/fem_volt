...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'fem-volt.com'
  config.app_name = 'Fem_volt'
  config.mailer.from = 'Fem_volt <no-reply@fem-volt.com>'
  ...
  #
  config.app_secret = 'ckXrnhrtQEQ5qPsoj3W5nfxTdy5TSvGZLwH_Gzw22Cw6yk02jr7mAKRv4cRxuzb6jjQ'
